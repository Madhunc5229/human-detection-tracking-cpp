...
/**
 * @brief In Sprint 1, this method returns the number of detected humans before
 * non-max suppression
 *
 * @param input_image
 * @param outputs
 ...
 * @return int
 */
int Identifier::drawIdentifier(const cv::Mat &input_image,
                               const std::vector<Mat> &predictions,
